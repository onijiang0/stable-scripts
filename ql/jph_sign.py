...
# /*
# ------------------------------------------
# @Description: 君品荟 - 签到/任务（对照 YYB-Go 改写，脱敏）
# cron: 34 19 * * *
# ------------------------------------------
# 变量名：jph
...
环境变量：
  ...
  WX_SERVER_URL     wx_server 地址（/wx/encryptkey 取密钥），默认 http://<lan-ip>:8787
...
WX_SERVER_URL = (os.getenv("WX_SERVER_URL") or "http://<lan-ip>:8787").rstrip("/")
